...
const methodologies: Record<Methodology, {
  ...
  waterfall: {
    ...
    phases: [
      { name: 'Requirements (Требования)', desc: 'Сбор и фиксация всех требований' },
      { name: 'Design (Проектирование)', desc: 'Архитектура и детальный дизайн системы' },
      { name: 'Implementation (Разработка)', desc: 'Разработка кода' },
      { name: 'Testing (Тестирование)', desc: 'Тестирование всей системы' },
      { name: 'Deployment (Развёртывание)', desc: 'Развёртывание в продакшн' },
      { name: 'Maintenance (Поддержка)', desc: 'Поддержка и исправление багов' },
    ],
  ...
  vmodel: {
    ...
    phases: [
      { name: 'Requirements ↔ Acceptance Testing (Требования ↔ Приёмочное тестирование)', desc: 'Требования валидируются приёмочными тестами' },
      { name: 'System Design ↔ System Testing (Системный дизайн ↔ Системное тестирование)', desc: 'Архитектура проверяется системными тестами' },
      { name: 'Detailed Design ↔ Integration Testing (Детальный дизайн ↔ Интеграционное тестирование)', desc: 'Детальный дизайн — интеграционные тесты' },
      { name: 'Coding ↔ Unit Testing (Кодирование ↔ Модульное тестирование)', desc: 'Код покрывается юнит-тестами' },
    ],
    pros: ['Тестирование планируется с самого начала', 'Раннее обнаружение дефектов', 'Хорошо для регулируемых отраслей (regulated industries)'],
  ...
  spiral: {
    ...
    phases: [
      { name: 'Planning (Планирование)', desc: 'Определение целей, ограничений, альтернатив' },
      { name: 'Risk Analysis (Анализ рисков)', desc: 'Анализ рисков и создание прототипов' },
      { name: 'Engineering (Разработка)', desc: 'Разработка и тестирование' },
      { name: 'Evaluation (Оценка)', desc: 'Оценка результата, планирование следующего витка' },
    ],
...
export default function WaterfallHybrid() {
  ...
  const scenarios = [
    ...
    { id: 3, text: 'Разработка ПО для медицинского оборудования. Каждый модуль должен быть протестирован.', answer: 'vmodel', explain: 'V-Model: раннее планирование тестов, требования к качеству, traceability (прослеживаемость требований) — критично для медицины.' },
  ]
    ...
    <div className="demo-container">
      ...
      <div className="card">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <a href="https://ru.wikipedia.org/wiki/Каскадная_модель" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-main)', fontSize: '0.9rem' }}>
            📖 Каскадная модель (Waterfall) — Википедия
          </a>
          <a href="https://ru.wikipedia.org/wiki/V-Model" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-main)', fontSize: '0.9rem' }}>
            📖 V-модель — Википедия
          </a>
        </div>
      </div>
