...
const mistakes = [
  ...
  { icon: '❌', title: 'Не записывать action items', desc: 'Если нет action items — встреча была бесполезной. Фиксируйте договорённости.' },
...
const templates = [
  ...
  },
  {
    ...
    agenda: [
      ...
      'Action items из прошлой встречи (3 мин)',
      'Есть ли фидбек для меня? (5 мин)',
    ]
  },
  {
    name: 'Performance review 1:1',
    duration: '60 мин',
    agenda: [
