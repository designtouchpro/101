...
const steps = [
  ...
  },
  {
    ...
    tips: ['Ищите win-win, а не компромисс', 'Фиксируйте договорённости письменно', 'Назначьте конкретные action items'],
  },
  {
...
const cases = [
  ...
  },
  {
    ...
    solution: [
      ...
      'Ввести change request процесс',
      'Показать PM метрики: как незапланированная работа влияет на velocity',
    ],
  },
]
