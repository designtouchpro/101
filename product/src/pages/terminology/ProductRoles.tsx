...
const roles: Role[] = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Принимает решения по scope спринта',
      'Является voice of customer для команды',
      'Участвует в grooming и planning',
    ],
    skills: ['Agile', 'Коммуникация', 'Приоритизация', 'Domain expertise'],
  ...
  },
  {
    ...
    skills: ['Лидерство', 'Стратегия', 'Business acumen', 'Hiring'],
    reports: 'CEO / Board',
    salary: '$150K-350K+',
