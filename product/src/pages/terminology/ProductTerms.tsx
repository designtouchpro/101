...
const terms: Term[] = [
  ...
  { term: 'PMF', abbr: 'Product-Market Fit', category: 'product', definition: 'Момент, когда продукт находит свой рынок. Пользователи сами приходят, retention высокий, растёт сарафанное радио (word-of-mouth).', example: 'Slack: команды стали приглашать другие команды без маркетинга.', related: ['NSM', 'Retention'] },
  ...
  { term: 'Churn Rate', category: 'metrics', definition: 'Процент пользователей/дохода, потерянных за период. Отток клиентов (Customer Churn) и отток дохода (Revenue Churn) считаются отдельно.', example: '1000 юзеров в начале месяца, 50 ушли → Churn = 5%', related: ['Retention', 'LTV'] },
  { term: 'ARPU', abbr: 'Average Revenue Per User', category: 'metrics', definition: 'Средний доход с одного пользователя за период. ARPPU (Average Revenue Per Paying User) — то же, но только среди платящих.', example: 'Freemium-игра: 10к DAU, $1000 дохода → ARPU = $0.10', related: ['ARPPU', 'LTV'] },
  ...
  { term: 'Backlog', category: 'processes', definition: 'Приоритизированный список задач/фич, которые нужно сделать. Бэклог продукта (Product Backlog) → Бэклог спринта (Sprint Backlog).', example: 'В бэклоге 200 задач, но в следующий спринт возьмём 8 из топа.', related: ['Grooming', 'Sprint'] },
