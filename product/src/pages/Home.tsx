...
const features = [
  ...
  { icon: '💰', title: 'Unit-экономика', desc: 'LTV, CAC, ARPU, Payback Period — считаем, сходится ли бизнес', to: '/metrics/unit-economics' },
  { icon: '⭐', title: 'North Star Metric', desc: 'Одна главная метрика, которая отражает ценность продукта', to: '/metrics/north-star' },
  ...
  { icon: '🔍', title: 'Product Discovery', desc: 'CustDev, Jobs-to-be-Done, Lean Canvas, Opportunity Tree', to: '/processes/discovery' },
  { icon: '🗺️', title: 'Roadmapping', desc: 'Now-Next-Later, OKR-based, Theme-based roadmaps', to: '/processes/roadmap' },
  ...
  { icon: '🚀', title: 'Go-to-Market', desc: 'Стратегии запуска, каналы, позиционирование', to: '/strategy/go-to-market' },
]
